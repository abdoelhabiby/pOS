    ...
    <div class="row">
				...
				<?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ord_date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>					
											  <div class="card">
											    <div class="card-header card-he2" id="headingThree">
											      <h5 class="mb-0">
											        <button class="btn btn-link collapsed fix-foo" data-toggle="collapse" data-target="#collapse<?php echo e($ord_date->id); ?>" aria-expanded="false" aria-controls="collapseThree">
                                    ...
                                    <?php if($ord_date->product->count() > 0): ?>
											    <div id="collapse<?php echo e($ord_date->id); ?>" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
											      <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/mypos/resources/views/dashboard/client/order/create.blade.php ENDPATH**/ ?>