...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item <?php echo e(request()->segment(3) == 'home' ? 'active' : ''); ?>">
  ...
  <?php if(auth()->user()->hasPermissionTo('read')): ?>
...
<?php endif; ?>
  ...
  <?php if(auth()->user()->hasPermissionTo('read_cat')): ?>

      <li class="nav-item <?php echo e(request()->segment(3) == 'category' ? 'active' : ''); ?>">
        <a class="nav-link " href="<?php echo e(url('dashboard/category')); ?>">
...
<?php endif; ?>
  ...
  <?php if(auth()->user()->hasPermissionTo('read_pro')): ?>

      <li class="nav-item <?php echo e(request()->segment(3) == 'products' ? 'active' : ''); ?>">
 ...
 <?php if(auth()->user()->hasPermissionTo('read_cli')): ?>

      <li class="nav-item <?php echo e(request()->segment(3) == 'client' ? 'active' : ''); ?>">
        <a class="nav-link " href="<?php echo e(url('dashboard/client')); ?>">
          <i class="fas fa-fw fa-star"></i>
          <span>Clients</span>
        </a>
      </li>
 ...
 <?php if(auth()->user()->hasPermissionTo('read_ord')): ?>
      ...
      <li class="nav-item <?php echo e(request()->segment(3) == 'orders' ? 'active' : ''); ?>">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" placeholder="<?php echo app('translator')->get('site.search'); ?>" aria-label="Search" aria-describedby="basic-addon2">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo e(asset(auth()->user()->image)); ?>">
              </a>
...
<script type="text/javascript" src="<?php echo e(asset('plugins/jquery-number/jquery.number.min.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('dashboard/js/custom.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('dashboard/js/printThis.js')); ?>"></script>
...
<?php /**PATH /home/ubuntu/F-DASHBOARD/resources/views/layouts/dashboard/app.blade.php ENDPATH**/ ?>