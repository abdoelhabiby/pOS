            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                ...
                <div class="card-footer">
                  <a href="{{route('category.index')}}" class="btn btn-primary d-flex justify-content-center">Show All</a>
                </div>
              </div>
            </div>
...
<!-- ========================================================================================== -->
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                ...
                <div class="card-footer">
                  <a href="{{route('products.index')}}" class="btn btn-success d-flex justify-content-center">Show All</a>
                </div>
              </div>
            </div>
...
<!-- ========================================================================================== -->
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                ...
                <div class="card-footer">
                  <a href="{{route('client.index')}}" class="btn btn-info d-flex justify-content-center">Show All</a>
                </div>
              </div>
            </div>
...
<!-- ========================================================================================== -->
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-danger shadow h-100 py-2">
                ...
                <div class="card-footer">
                  <a href="{{route('users.index')}}" class="btn btn-danger d-flex justify-content-center">Show All</a>
                </div>
              </div>
            </div>
